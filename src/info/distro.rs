            ...
            "Linux" | "BSD" | "MINIX" => {
                ...
                // Red Star OS
                    ...
                    long_name = {
                        ...
                        if release.is_err() {
                            to_return = String::from("Red Star OS");
                        } else {
                            to_return = release.unwrap();
                        }
                        to_return
                    };
...
impl From<[Option<&'static str>; 4]> for DistroColors {
    fn from(v: [Option<&'static str>; 4]) -> Self {
        ...
        let mut _2 = String::from(v[1].unwrap_or(v[0].unwrap_or("\u{001b}[38;5;7m")));
        let mut _3 =
            String::from(v[2].unwrap_or(v[1].unwrap_or(v[0].unwrap_or("\u{001b}[38;5;7m"))));
        let mut _4 = String::from(
            v[3].unwrap_or(v[2].unwrap_or(v[1].unwrap_or(v[0].unwrap_or("\u{001b}[38;5;7m")))),
        );
        if _2 == "\u{001b}[38;5;7m" {
            _2 = _1.clone();
        }
